...
def main():
    ...
    parser.add_argument("--spark-home", metavar="SPARK_HOME", required=False, help="Path to SPARK_HOME")
    ...
    parser.add_argument("--log-path", metavar="FILE", required=False, help="Path to log file", default=None)
    ...
    logger.debug("--conf: {}".format(spark_conf_list))
